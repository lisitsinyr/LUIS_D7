{********************************************************************}
{                                                                    }
{  Microsoft LAN Manager - Error messages                            }
{  Copyright(c) Microsoft Corp., 1987-1997                           }
{                                                                    }
{  Generated code by Petr Vones, 17.05.1999                          }
{                                                                    }
{********************************************************************}
...
uses
  Windows, Classes, SysUtils, LmErrLU;
...
begin
   ...
   if Length(Result) = 0 then Result := NetErrorMessage(ErrorCode);
//   if Length(Result) <> 0 then Result := IntToStr(ErrorCode)+' '+Result;
end;
...
begin
   ...
   if (Res <> NERR_Success) {and (Res <> ERROR_MORE_DATA)} then begin
      ...
      Error := EWin32Error.CreateFmt(sNetError, [Res, s]);
      Error.ErrorCode := Res;
      raise Error;
   end;
   Result := s;
