...
uses
  DB, Classes, StrUtils, LUSupport;

const
  MaxStrLen = 240; { This is an arbitrary limit }

type
   TFileType = (ftFixed, ftVarying);
...
{ TTextDataSet }
  ...
  public
    ...
    property Separator: TCharSet read FSeparator write FSeparator;
  published
...
procedure Register;
begin
  RegisterComponents('Luis', [TTextDataSet]);
end;
